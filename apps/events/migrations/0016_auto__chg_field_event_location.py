...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('events_event', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geo.Location'], null=True))
    def backwards(self, orm):

        # Changing field 'Event.location'
        db.alter_column('events_event', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['geo.Location']))
    models = {
        'cert.signature': {
        ...
        'events.event': {
            ...
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['geo.Location']", 'null': 'True'}),
