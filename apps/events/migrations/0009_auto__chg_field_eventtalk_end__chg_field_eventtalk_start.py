...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventTalk.end'
        db.alter_column('events_eventtalk', 'end', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'EventTalk.start'
        db.alter_column('events_eventtalk', 'start', self.gf('django.db.models.fields.TimeField')(null=True))
    def backwards(self, orm):

        # Changing field 'EventTalk.end'
        db.alter_column('events_eventtalk', 'end', self.gf('django.db.models.fields.TimeField')(default=datetime.datetime(2012, 10, 5, 0, 0)))

        # Changing field 'EventTalk.start'
        db.alter_column('events_eventtalk', 'start', self.gf('django.db.models.fields.TimeField')(default=datetime.datetime(2012, 10, 5, 0, 0)))
    models = {
        'events.event': {
