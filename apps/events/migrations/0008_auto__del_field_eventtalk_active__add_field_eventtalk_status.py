...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EventTalk.active'
        db.delete_column('events_eventtalk', 'active')

        # Adding field 'EventTalk.status'
        db.add_column('events_eventtalk', 'status',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'EventTalk.active'
        db.add_column('events_eventtalk', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'EventTalk.status'
        db.delete_column('events_eventtalk', 'status')
