...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('events_partner', 'logo',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100),
                      keep_default=False)

        # Deleting field 'Sponsor.logo'
        db.delete_column('events_sponsor', 'logo')

        # Deleting field 'Support.logo'
        db.delete_column('events_support', 'logo')

    def backwards(self, orm):
        # Deleting field 'Partner.logo'
        db.delete_column('events_partner', 'logo')

        # Adding field 'Sponsor.logo'
        db.add_column('events_sponsor', 'logo',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'Support.logo'
        db.add_column('events_support', 'logo',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100),
                      keep_default=False)
