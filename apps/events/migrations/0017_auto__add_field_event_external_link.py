...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('events_event', 'external_link',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Event.external_link'
        db.delete_column('events_event', 'external_link')
    ...
    models = {
        ...
        'events.event': {
            ...
            'external_link': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
