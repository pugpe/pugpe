...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventTalk.title'
        db.add_column('events_eventtalk', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True),
                      keep_default=False)


        # Changing field 'EventTalk.talk'
        db.alter_column('events_eventtalk', 'talk_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['submission.Talk'], null=True))
    def backwards(self, orm):
        # Deleting field 'EventTalk.title'
        db.delete_column('events_eventtalk', 'title')


        # User chose to not deal with backwards NULL issues for 'EventTalk.talk'
        raise RuntimeError("Cannot reverse this migration. 'EventTalk.talk' and its values cannot be restored.")
    models = {
        'cert.signature': {
